...
<spring:message code="menu.titulo"/>
	<ul>
		...
		<li>
			<spring:url value="/mostrar" var="mostrarUrl" htmlEscape="true" />
			<a href="${mostrarUrl }"><spring:message code="menu.mostrar"/> </a>
		</li>
		<li>
			<spring:url value="/editar" var="editarUrl" htmlEscape="true" />
			<a href="${editarUrl}"><spring:message code="menu.editar"/> </a>
		</li>
	</ul>
